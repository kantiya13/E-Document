                ...
                <?php
                  ...
                  if(isset($_POST['update'])){
                    ...
                    if($success){
                      ...
                      $sql = "UPDATE member SET m_fname = '".$_POST['fname']."', m_lname = '".$_POST['lname']."', m_phone = '".$_POST['phone']."', m_mail = '".$_POST['mail']."', m_profile = '".$img_name."' WHERE m_uname = '".$_SESSION['uname']."'";
                      mysqli_query($link,$sql);
                      echo '<script>window.location.href="pages-profile.php"</script>';
                    }else{
                      $sql = "UPDATE member SET m_fname = '".$_POST['fname']."', m_lname = '".$_POST['lname']."', m_phone = '".$_POST['phone']."', m_mail = '".$_POST['mail']."' WHERE m_uname = '".$_SESSION['uname']."'";
                      mysqli_query($link,$sql);
                      echo '<script>window.location.href="pages-profile.php"</script>';
                    }
                  }
                    ...
                    if(strlen($_POST['oldpass']) > 7 && strlen($_POST['oldpass']) < 17){
                      if(strlen($_POST['newpass']) > 7 && strlen($_POST['newpass']) < 17){
                        if($_POST['oldpass'] != $pass){
                          echo '<script>alert("รหัสผ่านไม่ถูกต้อง");window.location.href="pages-profile.php"</script>';
                        }else{
                          if($_POST['conpass'] != $_POST['newpass']){
                            echo '<script>alert("รหัสผ่านไม่ตรงกัน");window.location.href="pages-profile.php"</script>';
                          }else{
                        ...
                        echo '<script>alert("รหัสผ่านต้องมี 8 - 16 ตัวอักษร");window.location.href="pages-profile.php"</script>';
                      }
                    }else{
                      echo '<script>alert("รหัสผ่านต้องมี 8 - 16 ตัวอักษร");window.location.href="pages-profile.php"</script>';
                    }
