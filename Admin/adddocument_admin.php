                        ...
                        <form id="document" method="post" enctype="multipart/form-data"
                            ...
                            <div class="message-center ps ps--theme_default ps--active-y"
                                ...
                                <div class="form-group row mx-3">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control form-control-line" type="text" name="title"
                                               placeholder="กรุณาใส่ชื่อเรื่อง" required>
                                    </div>
                                </div>
                                <div class="form-group row mx-3">
                                    ...
                                    <div class="col-sm-3 pt-3">
                                        <input type="button" data-toggle="modal" data-target="#addType"
                                               class="btn btn-success" value="จัดการหมวดหมู่">
                                    </div>
                                </div>
