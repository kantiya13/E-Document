...
<section class="ptb-0">
    ...
    <div class="container">
        ...
        <a class="color-ash mt-10" href="addUser_admin.php">เพิ่มข้อมูลผู้ใช้งานระบบ</a>
    </div><!-- container -->
</section>
    ...
    <div class="container" style="min-height: 550px">
        ...
        if(isset($_POST['txtname'])){
            ...
            if ($success) {
                ...
                if ($objQuery) {
                    echo '<script>alert("สมัครสมาชิกสำเร็จ");window.location.href="allaccounts_admin.php";</script>';
                } else {
                    echo '<script>alert("สมัครสมาชิกไม่สำเร็จ กรุณาทำรายการใหม่อีกครั้ง");window.location.href="addUser_admin.php";</script>';
                }
            }else{
        ...
        <div class="row">
            <div class="card col-sm-12">
                <div class="col-sm-12 col-md-12 m-3">
                    <h3 class="mb-4"><b>เพิ่มข้อมูลผู้ใช้งานระบบ</b></h3>
