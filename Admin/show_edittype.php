...
<!-- แสดดงข้อมูล quiz 0  -->
    <div class="col-sm-12">
        <form action="fucntion_script/check_updateType.php?id=<?php echo $row['t_id']?>" class="form-block form-bold form-mb-20 form-h-35 form-brdr-b-grey pr-_จ pr-sm-0" method="post">
            <div class="row">
                <div class="col-sm-12">
