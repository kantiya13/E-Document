...
<section class="ptb-0">
    ...
    <div class="container">
        ...
        <a class="color-ash mt-10" href="profile_user.php">โปร์ไฟล์ </a>
    </div><!-- container -->
</section>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-4">
                <div class="col-xs-7 m-20" align="center">
                    <img src="../Admin/upload_file/<?php echo $objResult['m_profile']; ?>" class="rounded-circle1"/>
                </div>
            ...
            <div class="col-sm-12 col-md-8">
                <form class="form-block form-bold form-mb-20 form-h-35 form-brdr-b-grey pr-50 pr-sm-0" method="post"
                      action="fucntion_script/chech_updateProfile.php?id=<?php echo $_SESSION["UserID"]; ?>">
                    <div class="row">
                        <div class="col-sm-6">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form class="form-block form-bold form-mb-20 form-h-35 form-brdr-b-grey"
                              method="post"
                              action="fucntion_script/changePassword_user.php?user_id=<?php echo $_SESSION["UserID"]; ?>">
                            <!-- Modal body -->
